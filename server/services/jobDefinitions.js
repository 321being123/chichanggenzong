...
const JOB_CONTRACTS = {
  ...
  'hk_ipo_preopen': { externalApis: ['hkex_new_listings', 'hkex_prospectus'], producesDatasets: ['hk_ipo_facts'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 6 },
  ...
  'hk_ipo_enrichment': { externalApis: ['hkex_official_documents', 'hk_daily'], producesDatasets: ['hk_ipo_facts'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 20 },
