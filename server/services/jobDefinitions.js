...
const JOB_DEFINITION_SOURCE = [
  ...
  { jobCode: 'ipo_history_sync', label: 'IPO事实同步', hour: 18, minute: 0, weekdays: true, additionalSchedules: [{ hour: 19, minute: 30, mode: 'enrichment' }], catchupMode: 'latest_only', dataDatePolicy: 'latest_available', freshnessGate: true, strictDatasetPublication: true, deadlineMinutes: 240, sourceDescription: 'Tushare新股事实；晚间定点补全行业、主营业务和首日表现', mayConsumeQuota: true, externalSources: ['tushare', 'tencent', '公告'], retryPolicy: 'external', retryDelaysMinutes: [15, 60], maxAttempts: 3 },
  ...
  { jobCode: 'hk_ipo_preopen', label: '港股 IPO 盘前事实同步', hour: 8, minute: 30, weekdays: true, catchupMode: 'latest_only', requiresDataWatermark: false, dailyBudget: 0, datasetDependencies: [{ datasetCode: 'hk_trade_calendar', scopeKey: 'HK', partitionDatePolicy: 'business_date' }], sourceDescription: '港交所主板/GEM 新上市页面、官方披露易、腾讯行情名称与利弗莫尔申购期信号', mayConsumeQuota: true, externalSources: ['hkex', 'livermore', 'tencent'], retryPolicy: 'external', retryDelaysMinutes: [15, 60], maxAttempts: 3 },
...
const JOB_CONTRACTS = {
  ...
  'hk_ipo_preopen': { externalApis: ['hkex_new_listings', 'hkex_prospectus', 'livermore_hk_ipo_current', 'tencent_quote'], producesDatasets: ['hk_ipo_facts', 'hk_ipo_subscription_signals'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 7 },
  ...
  'hk_ipo_enrichment': { externalApis: ['hkex_official_documents', 'hkex_history_report', 'hk_daily', 'livermore_hk_ipo_history', 'futu_hk_ipo_page', 'tencent_quote'], producesDatasets: ['hk_ipo_facts', 'hk_ipo_grey_market_signals'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 28 },
