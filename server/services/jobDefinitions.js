...
const JOB_DEFINITIONS = [
  ...
  { jobCode: 'convertible_bond_universe_refresh', label: '可转债行情同步', hour: 8, minute: 0, weekdays: true, afterTradingDay: true, catchupMode: 'latest_only', dataDatePolicy: 'previous_trading_day', freshnessGate: true, sourceDescription: '腾讯行情与 Tushare 接口', mayConsumeQuota: true, externalSources: ['tencent', 'tushare'], retryPolicy: 'external', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
  ...
  { jobCode: 'convertible_bond_revision_motive_inputs_sync', label: '下修动机输入增量同步', hour: 7, minute: 20, weekdays: true, afterTradingDay: true, catchupMode: 'latest_only', dataDatePolicy: 'latest_available', freshnessGate: false, requiresDataWatermark: false, sourceDescription: 'Tushare 持有人与质押接口，结果写入事实库', mayConsumeQuota: true, externalSources: ['tushare'], retryPolicy: 'external', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
