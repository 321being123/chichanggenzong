...
assert.doesNotMatch(source, /first_day_retry_count,0\) < 3/, '首日涨幅补偿不应永久放弃第 4 次及后续重试');
assert.doesNotMatch(source, /cutoff = today - timedelta\(days=14\)/, '首日涨幅补偿不应只覆盖最近 14 天');
