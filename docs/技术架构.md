...
| 打新日历与日报 | 工作日 18:05；资料补全后 19:45 刷新 | 依赖 17:30 可转债统一公告任务成功，以及同业务日 `ipo_history`、`bond_issuance_events` 分区已发布且基础质量通过；不把历史任务成功状态当作当天事实证据。18:05/19:45 均只读数据库生成，发布前与日历证券集合对账，失败保留上一份有效结果 |
