...
const JOB_DEFINITION_SOURCE = [
  ...
  { jobCode: 'hk_rate', label: '港币汇率更新', hour: 16, minute: 15, weekdays: true, deadlineMinutes: 90, dataDatePolicy: 'latest_available', freshnessGate: true, freshnessMode: 'max_age', freshnessMaxAgeMinutes: 1440, sourceDescription: '港币实时汇率接口，失败时使用每日汇率接口兜底', mayConsumeQuota: true, externalSources: ['exchange-rate'], retryPolicy: 'external', retryDelaysMinutes: [15, 60], maxAttempts: 3 },
