...
const STATEMENTS = {
  balance: { name:'资产负债表', sections:[
    ...
    ['流动资产',[['money_cap','货币资金'],['trad_asset','交易性金融资产'],['notes_receiv','应收票据'],['accounts_receiv','应收账款'],['accounts_receiv_bill','应收票据及应收账款'],['oth_receiv','其他应收款'],['oth_rcv_total','其他应收款合计'],['prepayment','预付款项'],['div_receiv','应收股利'],['int_receiv','应收利息'],['inventories','存货'],['contract_assets','合同资产'],['hfs_assets','持有待售资产'],['nca_within_1y','一年内到期的非流动资产'],['oth_cur_assets','其他流动资产']]],
    ['非流动资产',[['lt_eqt_invest','长期股权投资'],['invest_real_estate','投资性房地产'],['debt_invest','债权投资'],['oth_debt_invest','其他债权投资'],['fix_assets','固定资产'],['fix_assets_total','固定资产合计'],['cip','在建工程'],['cip_total','在建工程合计'],['intan_assets','无形资产'],['r_and_d','开发支出'],['goodwill','商誉'],['lt_amor_exp','长期待摊费用'],['defer_tax_assets','递延所得税资产'],['oth_nca','其他非流动资产']]],
    ...
    ['流动负债',[['st_borr','短期借款'],['notes_payable','应付票据'],['acct_payable','应付账款'],['accounts_pay','应付票据及应付账款'],['adv_receipts','预收款项'],['contract_liab','合同负债'],['payroll_payable','应付职工薪酬'],['taxes_payable','应交税费'],['int_payable','应付利息'],['div_payable','应付股利'],['oth_payable','其他应付款'],['oth_pay_total','其他应付款合计'],['non_cur_liab_due_1y','一年内到期的非流动负债'],['oth_cur_liab','其他流动负债']]],
    ['非流动负债',[['lt_borr','长期借款'],['bond_payable','应付债券'],['lt_payable','长期应付款'],['long_pay_total','长期应付款合计'],['estimated_liab','预计负债'],['defer_tax_liab','递延所得税负债'],['defer_inc_non_cur_liab','递延收益（非流动负债）'],['oth_ncl','其他非流动负债']]],
  ...
  income: { name:'利润表', sections:[
    ['营业收入',[['total_revenue','营业总收入'],['revenue','营业收入'],['int_income','利息收入'],['prem_earned','已赚保费'],['comm_income','手续费及佣金收入'],['n_commis_income','手续费及佣金净收入'],['n_sec_tb_income','代理买卖证券业务净收入'],['n_sec_uw_income','证券承销业务净收入'],['n_asset_mg_income','受托客户资产管理业务净收入'],['oth_b_income','其他业务收入']]],
    ['营业成本及费用',[['total_cogs','营业总成本'],['oper_cost','营业成本'],['int_exp','利息支出'],['comm_exp','手续费及佣金支出'],['biz_tax_surchg','税金及附加'],['sell_exp','销售费用'],['admin_exp','管理费用'],['fin_exp','财务费用'],['rd_exp','研发费用'],['assets_impair_loss','资产减值损失'],['credit_impa_loss','信用减值损失'],['other_bus_cost','其他业务成本']]],
    ['其他收益与损失',[['fv_value_chg_gain','公允价值变动收益'],['invest_income','投资收益'],['ass_invest_income','对联营和合营企业投资收益'],['forex_gain','汇兑收益']]],
    ['利润形成',[['operate_profit','营业利润'],['non_oper_income','营业外收入'],['non_oper_exp','营业外支出'],['nca_disploss','非流动资产处置净损失'],['total_profit','利润总额'],['income_tax','所得税费用'],['n_income','净利润'],['continued_net_profit','持续经营净利润'],['n_income_attr_p','归母净利润'],['minority_gain','少数股东损益']]],
  ...
  cashflow: { name:'现金流量表', sections:[
    ['经营活动现金流入',[['c_fr_sale_sg','销售商品、提供劳务收到的现金'],['recp_tax_rends','收到的税费返还'],['c_fr_oth_operate_a','收到其他与经营活动有关的现金'],['c_inf_fr_operate_a','经营活动现金流入小计']]],
    ['经营活动现金流出',[['c_paid_goods_s','购买商品、接受劳务支付的现金'],['c_paid_to_for_empl','支付给职工以及为职工支付的现金'],['c_paid_for_taxes','支付的各项税费'],['oth_cash_pay_oper_act','支付其他与经营活动有关的现金'],['st_cash_out_act','经营活动现金流出小计'],['n_cashflow_act','经营活动现金流量净额']]],
    ['投资活动现金流',[['c_recp_return_invest','收回投资收到的现金'],['n_recp_disp_fiolta','处置长期资产收到的现金净额'],['oth_recp_ral_inv_act','收到其他与投资活动有关的现金'],['stot_inflows_inv_act','投资活动现金流入小计'],['c_pay_acq_const_fiolta','购建长期资产支付的现金'],['c_paid_invest','投资支付的现金'],['oth_pay_ral_inv_act','支付其他与投资活动有关的现金'],['stot_out_inv_act','投资活动现金流出小计'],['n_cashflow_inv_act','投资活动现金流量净额']]],
    ['筹资活动现金流',[['c_recp_cap_contrib','吸收投资收到的现金'],['c_recp_borrow','取得借款收到的现金'],['proc_issue_bonds','发行债券收到的现金'],['oth_cash_recp_ral_fnc_act','收到其他与筹资活动有关的现金'],['stot_cash_in_fnc_act','筹资活动现金流入小计'],['c_prepay_amt_borr','偿还债务支付的现金'],['c_pay_dist_dpcp_int_exp','分配股利、利润或偿付利息支付的现金'],['oth_cashpay_ral_fnc_act','支付其他与筹资活动有关的现金'],['stot_cashout_fnc_act','筹资活动现金流出小计'],['n_cash_flows_fnc_act','筹资活动现金流量净额']]],
...
for (const definition of Object.values(STATEMENTS)) {
  definition.fields = definition.sections.flatMap(([section, fields]) => fields.map(([code,label]) => [code,label,section]));
}
