(function () {
  function renderStabilityChart(s, selectedRange) {
    ...
    var oldTooltip=document.querySelector('.stock-analysis-chart-tooltip[data-stock-analysis-tooltip]');if(oldTooltip)oldTooltip.remove();el.innerHTML=controls()+summary()+'<div class="stock-analysis-chart">'+legend+'<svg viewBox="0 0 '+W+' '+H+'" style="width:100%;min-width:'+W+'px" role="img" aria-label="盈利与分红稳定性图表">'+svg.join('')+'</svg><div class="stock-analysis-chart-tooltip app-tooltip" data-stock-analysis-tooltip="1"></div></div>'+historyTable();bindFilters();
