...
const JOB_CONTRACTS = {
  ...
  'hk_rate': { externalApis: ['exchange_rate_realtime', 'exchange_rate'], producesDatasets: ['hk_fx_rate'], consumesDatasets: [], maxExternalCallsPerRun: 2 },
