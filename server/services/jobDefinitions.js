...
const JOB_DEFINITIONS = [
  { jobCode: 'bond_safety_refresh', label: '可转债安全评分', hour: 6, minute: 30, weekdays: true, deadlineMinutes: 120, dataDatePolicy: 'previous_trading_day', freshnessGate: true, sourceDescription: '已配置的公司与可转债资料接口', mayConsumeQuota: true, externalSources: ['tushare', '公告'], retryPolicy: 'external', retryDelaysMinutes: [15, 60], maxAttempts: 3 },
