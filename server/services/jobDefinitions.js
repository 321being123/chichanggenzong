...
const JOB_CONTRACTS = {
  ...
  'convertible_bond_announcement_history_sync': { externalApis: ['cninfo', 'sse', 'szse'], producesDatasets: ['bond_announcement_facts'], consumesDatasets: ['bond_master'], maxExternalCallsPerRun: 600, dailyBudget: 4 },
