...
> 2026-09-23 A股 IPO 与日报依赖修复（本地全量回归和知识门禁通过，待生产验收）：识别投资风险特别公告中的行业 PE、基准日和未盈利证据；行业 PE 缺口时按交易所优先、既有 CNINFO 备源补全；缺发行 PE 不再仅凭上市日期推断亏损。可转债流通规模筛选改为绑定 SQL 参数，修复 `%` 造成的查询异常。
