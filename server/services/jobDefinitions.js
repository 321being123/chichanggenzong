...
const JOB_DEFINITION_SOURCE = [
  { jobCode: 'company_financial_incremental_sync', label: '公司财务增量同步', hour: 6, minute: 30, weekdays: false, catchupMode: 'latest_only', dataDatePolicy: 'latest_available', freshnessGate: false, requiresDataWatermark: false, strictDatasetPublication: true, dailyBudget: 0, deadlineMinutes: 120, timeoutMinutes: 30, sourceDescription: 'Tushare披露计划与财务标准层；按公司、报告期增量入库', mayConsumeQuota: true, externalSources: ['tushare'], retryPolicy: 'external', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
