...
const JOB_DEFINITION_SOURCE = [
  { jobCode: 'bond_safety_refresh', label: '可转债安全评分', hour: 8, minute: 30, weekdays: true, afterTradingDay: true, deadlineMinutes: 120, dataDatePolicy: 'previous_trading_day', freshnessGate: true, dependencyCodes: ['convertible_bond_universe_refresh'], sourceDescription: '已发布的共享标准行情与财务标准层；本地计算', mayConsumeQuota: false, externalSources: [], retryPolicy: 'local', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
