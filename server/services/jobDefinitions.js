...
const JOB_DEFINITIONS = [
  ...
  { jobCode: 'convertible_bond_redemption_announcement_sync', label: '可转债强赎公告同步', hour: 7, minute: 45, weekdays: true, catchupMode: 'latest_only', dataDatePolicy: 'latest_available', freshnessGate: false, sourceDescription: '巨潮资讯官方公告', mayConsumeQuota: true, externalSources: ['巨潮资讯'], retryPolicy: 'external', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
