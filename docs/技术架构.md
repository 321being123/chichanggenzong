...
2026-09-20 港股历史页现场复核：线上 181 条港股记录中，中文名 177 条、公开发售起止日期各 172 条、配售日期 166 条、最终发行价 172 条、最终超购 168 条；动态申购/孖展信号当前无有效快照。对截图对象核对后确认 06700/09856 的官方配发公告尚未到招股书规定截止时间，06727 的 9 月 18 日结果在当日 19:40 槽位之后发布。版本 `0.8.1.74` 已局部修正为读取 `offer_phase`，显示完整招股窗口和有语义的待公告状态，不以空值冒充实时或最终事实；生产发布后继续核对静态资源和接口。
