...
> 最后核对日期：2026-09-18。应用版本以根目录 `package.json` 的 `appVersion` 为准。
> 2026-09-18 版本 0.8.1.68：0.8.1.67 已将 208 条未完整解析收敛至华源转债 1 条；其正文明确披露“到期日为 2024年11月27日”及无法实施有条件赎回。至到期证据解析现同时接受“将于某日到期”和“到期日为某日”，仍要求无法办理/实施/行使赎回的同段正文证据。
