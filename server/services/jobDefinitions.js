...
const JOB_DEFINITIONS = [
  { jobCode: 'bond_safety_refresh', label: '可转债安全评分', hour: 6, minute: 30, weekdays: true, deadlineMinutes: 120, sourceDescription: '已配置的公司与可转债资料接口', mayConsumeQuota: true },
  ...
  { jobCode: 'market_volatility_sync', label: '股市波动指标', hour: 18, minute: 45, weekdays: true, deadlineMinutes: 240, sourceDescription: '中债、中证指数、恒生指数、香港金管局及 Tushare 接口', mayConsumeQuota: true },
  { jobCode: 'convertible_bond_valuation_refresh', label: '可转债估值预警', hour: 18, minute: 15, weekdays: true, deadlineMinutes: 360,
    dependencyCodes: ['convertible_bond_universe_refresh', 'market_volatility_sync'] },
  ...
  { jobCode: 'hk_trade_rules_sync', label: '港股每手股数同步', hour: 20, minute: 30, weekdays: true, deadlineMinutes: 360, sourceDescription: '港交所证券资料接口' },
  ...
  { jobCode: 'holiday_sync', label: '休市日历月度同步', hour: 7, minute: 0, weekdays: false, monthly: true, deadlineMinutes: 1440, catchupWindowMinutes: 43200, category: 'system', importance: 'high' },
