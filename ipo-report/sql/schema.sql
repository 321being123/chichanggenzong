...
CREATE TABLE IF NOT EXISTS ipo_history (
  ...
  market_code           TEXT NOT NULL DEFAULT 'CN',
  ipo_status            TEXT NOT NULL DEFAULT 'active',
  ipo_status_at         TIMESTAMPTZ,
  offer_open_at         TIMESTAMPTZ,
  offer_close_at        TIMESTAMPTZ,
  pricing_at            TIMESTAMPTZ,
  allotment_at          TIMESTAMPTZ,
  listing_at            TIMESTAMPTZ,
  issue_price_low       NUMERIC(20,8),
  issue_price_high      NUMERIC(20,8),
  issue_price_final     NUMERIC(20,8),
  lot_size_shares       NUMERIC(20,4),
  lot_amount_hkd        NUMERIC(20,4),
  application_fee_hkd   NUMERIC(20,4),
  brokerage_fee_hkd     NUMERIC(20,4),
  public_offer_ratio    NUMERIC(12,8),
  international_offer_ratio NUMERIC(12,8),
  cornerstone_details   JSONB NOT NULL DEFAULT '{}'::jsonb,
  greenshoe_details     JSONB NOT NULL DEFAULT '{}'::jsonb,
