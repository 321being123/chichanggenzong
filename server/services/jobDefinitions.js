...
const JOB_CONTRACTS = {
  ...
  'hk_ipo_preopen': { externalApis: ['hkex_new_listings', 'hkex_prospectus', 'livermore_hk_ipo_current'], producesDatasets: ['hk_ipo_facts', 'hk_ipo_subscription_signals'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 7 },
  'hk_ipo_postclose': { externalApis: ['hkex_allotment', 'hkex_title_search', 'hkex_market'], producesDatasets: ['hk_ipo_facts'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 12 },
  'hk_ipo_enrichment': { externalApis: ['hkex_official_documents', 'hk_daily', 'livermore_hk_ipo_history', 'futu_hk_ipo_page'], producesDatasets: ['hk_ipo_facts', 'hk_ipo_grey_market_signals'], consumesDatasets: ['hk_trade_calendar'], maxExternalCallsPerRun: 24 },
