...
| 打新日历与日报 | 工作日 18:05；资料补全后 19:45 刷新 | 只依赖同业务日 `ipo_history`、`bond_issuance_events` 分区已发布且基础质量通过，不绑定 `ipo_history_sync` 或可转债任务的整体成功状态；18:05/19:45 均只读数据库生成，发布前与日历证券集合对账，失败保留上一份有效结果 |
