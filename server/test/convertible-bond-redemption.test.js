...
assert.ok(stockAnalysis.includes('rows.length >= announceCount') && stockAnalysis.includes('!Number.isFinite(announceCount)') && stockAnalysis.includes('maxPages = 20'), '深交所公告分页必须按公告总数判断完整性并支持交易所主链分页');
