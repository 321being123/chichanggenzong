...
const JOB_DEFINITIONS = [
  ...
  { jobCode: 'convertible_bond_announcement_history_sync', label: '可转债下修与转股价公告事实同步', hour: 7, minute: 40, weekdays: true, catchupMode: 'latest_only', dataDatePolicy: 'latest_available', freshnessGate: true, requiresDataWatermark: true, reconcileByWatermark: true, deadlineMinutes: 240, timeoutMinutes: 120, importance: 'high', sourceDescription: '巨潮资讯与交易所官方公告，结果写入公告事实库', mayConsumeQuota: true, externalSources: ['巨潮资讯', '上交所', '深交所'], retryPolicy: 'external', retryDelaysMinutes: [15, 60, 240], maxAttempts: 4 },
