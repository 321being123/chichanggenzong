...
const JOB_LABELS = {
  ...
  hk_trade_calendar_sync: '港交所交易日历同步',
  hk_ipo_preopen: '港股IPO盘前事实同步',
  hk_ipo_postclose: '港股IPO盘后事实同步',
  hk_ipo_enrichment: '港股IPO官方文件补全',
...
function renderOps() {
  ...
  el.innerHTML =
    '<div class="ops-grid">' +
      opsCard('可转债安全性刷新', '手动触发全部可转债安全评分快照刷新（每日 08:30 自动跑，此处用于立即生效或补救）。',
