...
const JOB_CONTRACTS = {
  ...
  'convertible_bond_announcement_history_sync': { externalApis: ['cb_issue', 'sse', 'szse', 'cninfo'], producesDatasets: ['bond_announcement_facts', 'bond_issuance_events', 'bond_redemption_events'], consumesDatasets: ['bond_master'], maxExternalCallsPerRun: null },
  ...
  'arbitrage_sync': { externalApis: ['hkex', 'sse', 'szse', 'cninfo'], producesDatasets: ['arbitrage_cases'], consumesDatasets: [], maxExternalCallsPerRun: null },
