...
const {
  dateText, normalizeBondCode, normalizeHolderName, holderType, saveHolderRow, diffHolderSnapshots, buildRevisionCycles, buildMotiveScore, calculateExecutability, buildFinancial,
...
const high = buildMotiveScore({
  qualityStatus: 'complete', tradeDate: '2026-08-28', bondClose: 98, stockClose: 5, stockVwap: 5, stockPb: 1,
...
assert.notStrictEqual(partial.motiveLevel, 'unavailable', '部分数据但已有评分项时不能显示暂无数据');
